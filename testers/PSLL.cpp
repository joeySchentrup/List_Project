...
TEST_CASE("PSLL: Tests the iterators using for each") {
...
TEST_CASE("PSLL: Tests the iterators using begin and end and ++ operators") {
    ...
    PSLL<int>::PSLL_Iter<PSLL<int>,int> iter = list->begin();
    PSLL<int>::PSLL_Iter<PSLL<int>,int> end = list->end();
